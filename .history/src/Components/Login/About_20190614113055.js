    ...
    render() {
        return (
            ...
            <div className="welcome" style={{ background: "white" }}>
                ...
                <p>
                    <p>Our mission is what inspires us to be the top option for students aiming to venture into the field of technology.</p>
                    <p></p>We create opportunities to network, collaborate, and showcase the diverse talents of our students. <p> Our company partners
